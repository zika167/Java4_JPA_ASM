...
<footer class="mt-auto pb-0">
    <div class="container p-4 bg-dark text-warning text-center text-lg-start pb-0"
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                ...
                <p class="mb-2"><i class="fas fa-map-marker-alt me-2"></i>123 Đường ABC, TP.HCM</p>
                <p class="mb-2"><i class="fas fa-phone me-2"></i>0123 456 789</p>
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled mb-0">
                    <li class="mb-2"><a href="/gioi-thieu" class="text-warning text-decoration-none">Giới thiệu</a></li>
                    <li class="mb-2"><a href="/dich-vu" class="text-warning text-decoration-none">Dịch vụ</a></li>
                    <li class="mb-2"><a href="/chinh-sach" class="text-warning text-decoration-none">Chính sách bảo mật</a></li>
                    <li><a href="/lien-he" class="text-warning text-decoration-none">Liên hệ</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                ...
                <div class="d-flex gap-3">
                    <a href="#" class="text-warning"><i class="fab fa-facebook-f fs-4"></i></a>
                    <a href="#" class="text-warning"><i class="fab fa-twitter fs-4"></i></a>
                    <a href="#" class="text-warning"><i class="fab fa-instagram fs-4"></i></a>
                    <a href="#" class="text-warning"><i class="fab fa-youtube fs-4"></i></a>
                </div>
            </div>
        </div>
    </div>
